...
class Notification implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    {
        $this->container['to_sms_phone'] = $data['to_sms_phone'] ?? null;
        $this->container['to_email'] = $data['to_email'] ?? null;
     ...
     * @return string|null
     */
    public function getToSmsPhone()
    {
        return $this->container['to_sms_phone'];
    }
